...
RUN apt-get install -y curl grep sed dpkg git xvfb && \
...
ADD https://github.com/mozilla/geckodriver/releases/download/v0.12.0/geckodriver-v0.12.0-linux64.tar.gz /bin/
